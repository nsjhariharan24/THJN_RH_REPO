...
class LidarReactiveNavigator(Node):
    def __init__(self):
        ...
        self.create_subscription(Bool, '/shape_stop_signal', self.shape_stop_cb, 10)

        # ---------------- Shape stop flag ----------------
        self.shape_stop = False
    ...
    def shape_stop_cb(self, msg: Bool):
        self.shape_stop = msg.data
    ...
    def scan_callback(self, msg):
        # 🚨 SHAPE DETECTOR ACTIVE → PAUSE NAVIGATION
        if self.shape_stop:
            self.stop_robot()
            return
    ...
    # =====================================================
    # GRID-BASED RETURN HOME (UNCHANGED)
    # =====================================================
    ...
    def return_to_home(self):
        ...
        if self.return_state == "GO_X":
            dx = self.home_x - self.current_x - 0.18
