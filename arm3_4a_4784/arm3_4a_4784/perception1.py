...
class CombinedPerception(Node):
    ...
    def process(self):
        ...
        # 1️⃣ Fertilizer can ArUco ONLY
        self.detect_fertilizer_can(frame)
    ...
    # ---------------- Fertilizer CAN ArUco ONLY ----------------

    def detect_fertilizer_can(self, frame):
        gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
        #cv2.imshow("gerey scale ",gray)
        ...
        for i, mid in enumerate(ids.flatten()):
            ...
            # ❌ Ignore all except fertilizer can
